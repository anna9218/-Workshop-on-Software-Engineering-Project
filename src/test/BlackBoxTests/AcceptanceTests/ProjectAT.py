...
class ProjectAT(ABC, unittest.TestCase):
    ...
    def delete_manager(self, store_name: str, appointee_nickname: str):
        self.__bridge.delete_manager(self._username, store_name, appointee_nickname)
    ...
    def add_products_to_cart(self, product_name: str, store_name: str, amount: int, discount_type: int,
        ...
        return self.__bridge.add_products_to_cart(self._username, product_name, store_name, amount, discount_type,  purchase_type)

    # 2.7 update cart
    def view_shopping_cart(self):
        return self.__bridge.view_shopping_cart(self._username)

    def update_shopping_cart(self, flag: str,
                             products_details: [{"product_name": str, "store_name": str, "amount": int}]):
        return self.__bridge.update_shopping_cart(self._username, flag, products_details)

    # 2.8 purchase products
    def purchase_products(self) -> dict:
        return self.__bridge.purchase_products(self._username)
    ...
    def confirm_purchase(self, delivery_details: {'name': str, 'address': str, 'city': str, 'country': str, 'zip': str},
                         payment_details: {'card_number': str, 'month': str, 'year': str, 'holder': str,
                                           'ccv': str, 'id': str},
                         purchase_ls: []) -> bool:
        return self.__bridge.confirm_purchase(self._username, delivery_details, payment_details, purchase_ls)

    def remove_purchase(self, store_name: str, purchase_date: datetime):
        self.__bridge.remove_purchase(self._username, store_name, purchase_date)

    # 3.1 logout functions
    def logout(self) -> bool:
        return self.__bridge.logout(self._username)

    # 3.2 open store functions
    def open_store(self, store_name: str) -> bool:
        return self.__bridge.open_store(self._username, store_name)
    ...
    def view_personal_purchase_history(self):
        return self.__bridge.view_personal_purchase_history(self._username)
    ...
    def add_products_to_store(self, store_name: str, products_details:
                                            [{"name": str, "price": int, "category": str, "amount": int,
                                              "purchase_type": int}]) -> bool:
        return self.__bridge.add_products_to_store(self._username, store_name, products_details)

    def edit_products_in_store(self, store_name: str, product_name: str, op: str, new_value: str) -> bool:
        return self.__bridge.edit_products_in_store(self._username, store_name, product_name, op, new_value)

    def remove_products_from_store(self, store_name: str, products_names: list) -> bool:
        return self.__bridge.remove_products_from_store(self._username, store_name, products_names)
    ...
    def get_policies(self, policy_type: str, store_name: str) -> [dict] or None:
        return self.__bridge.get_policies(self._username, policy_type, store_name)
    ...
    def update_purchase_policy(self, store_name: str, details: {"name": str, "products": [str] or None,
        ...
        return self.__bridge.update_purchase_policy(self._username, store_name, details)

    def define_purchase_policy(self, store_name: str, details: {"name": str, "products": [str],
                                                                "min_amount": int or None, "max_amount": int or None,
                                                                "dates": [dict] or None, "bundle": bool or None}):
        return self.__bridge.define_purchase_policy(self._username, store_name, details)
    ...
    def update_discount_policy(self, store_name: str, policy_name: str,
        ...
        return self.__bridge.update_discount_policy(self._username, store_name, policy_name, percentage, valid_util,
    ...
    def define_composite_policy(self, store_name: str, policy1_name: str, policy2_name: str, flag: str,
        ...
        return self.__bridge.define_composite_policy(self._username, store_name, policy1_name, policy2_name, flag, percentage, name,
                                                     valid_until)
    ...
    def define_discount_policy(self, store_name: str,
        ...
        return self.__bridge.define_discount_policy(self._username, store_name, percentage, valid_until, discount_details,
                                                    discount_precondition)

    # 4.3 add store owner functions
    def appoint_additional_owner(self, nickname: str, store_name: str) -> bool:
        return self.__bridge.appoint_additional_owner(self._username, nickname, store_name)

    # 4.4 remove store owner
    def remove_owner(self, appointee_nickname: str, store_name: str) -> {'response': [], 'msg': str}:
        return self.__bridge.remove_owner(self._username, appointee_nickname, store_name)
    ...
    def edit_manager_permissions(self, store_name: str, appointee_nickname: str, permissions: list) -> bool:
        return self.__bridge.edit_manager_permissions(self._username, store_name, appointee_nickname, permissions)

    # 4.7 remove manager functions
    def remove_manager(self, store_name: str, manager_nickname: str) -> bool:
        return self.__bridge.remove_manager(self._username, store_name, manager_nickname)
    ...
    def manager_view_shop_purchase_history(self, store_name: str):
        return self.__bridge.manager_view_shop_purchase_history(self._username, store_name)
