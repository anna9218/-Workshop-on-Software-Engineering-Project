...
from src.main.DomainLayer.UserComponent.ShoppingBasket import ShoppingBasket, PurchaseType, DiscountType
...
class ShoppingCart:
    ...
    @logger
    def make_purchase(self, username: str):
        """
        ...
        for basket in self.__shopping_baskets:
            ...
            if res_i is not None:
                p = Purchase(res_i["dict"], res_i["basket_price"], basket["store_name"], username)
