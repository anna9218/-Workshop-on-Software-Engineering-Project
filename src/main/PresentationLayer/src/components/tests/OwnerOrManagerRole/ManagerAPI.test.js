...
import ManagerAPI from '../../OwnerOrManagerRole/ManagerAPI'
...
describe('systemManagerAPI Test Suite', () => {
  ...
  it('should render the form', () => {
      const wrapper = shallow(<ManagerAPI />);  // shallow renders a single component each time. In other words, Enzyme won’t consider the child elements for the test.
